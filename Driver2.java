public class Driver2 {
    ...
    public static boolean decrypt(byte[] Key){ //copied from AESExample.java (majority so)
        try{
                ...
                for (int k = 0; k <= 255; k++) {
                    ...
                    for (int l = 0; l <= 255; l++) {
                        ...
                        if (decrypt(inKey)) {
                            ...
                            System.out.println("time elapsed: " + (end - begin) / 1000000000 + " seconds");
                            return;
                        }
